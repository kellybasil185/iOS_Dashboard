...
const API_BASE_URL = 'https://backend-production-f6dd.up.railway.app'; // e.g., 'https://your-id.ngrok-free.app' or http://localhost:3001
...
export default function NewNotificationWidget() {
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <View style={[styles.widgetContainer, { backgroundColor: isDark ? '#37335c' : '#969596' }]}>
